#!/usr/bin/python
# 
# This script will take a CSV file containing a list of email addresses and add them to 
# an Okta group specified in the list. If any email addreses do not correspond to Okta 
# user accounts those email addresses will output to another csv file "emails_not_found.csv" 
# in the same directory as the script.
#
# To setup, replace {api_token} with the API token from Okta and ensure the base_url is set.
#
# Rory Aptekar
# 2019.08.03
#
...
for i in user_ids:
    ...
    print("Adding " + email_address[count][0] + " to the Okta group \"" + group_selected_name + "\"")
